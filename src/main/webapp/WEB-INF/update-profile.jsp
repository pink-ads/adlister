    ...
    <body>
        ...
        <div class="container">
            <div class="tinted-image container-fluid mb-5 mt-3">
                <h3 class=" text-center">Update <span class="badge badge-info">Profile</span></h3>
            </div>
                ...
                <div class="col-5 ">
                    <form action="/updateProfile" method="POST">
                        <div class="form-group">
                            ...
                            <textarea id="new-username" name="new-username" style="resize:none;" rows="1"
                                      class="form-control"
                                      type="text">${username}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="new-email">Update Email</label>
                            <textarea id="new-email" name="new-email" style="resize:none;" rows="1" class="form-control"
                                      type="text">${email}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="new-password">Update Password</label>
                            <textarea id="new-password" name="new-password" style="resize:none;" rows="1"
                                      class="form-control"
